...
public class VistaLibro extends JPanel {
    ...
    //***********************setCampos***********************//
    public void setCampo1(String n) {
        campo1.setText(n);
    }

    public void setCampo2(String n) {
        campo2.setText(n);
    }

    public void setCampo3(String n) {
        campo3.setText(n);
    }

    public void setCampo4(String n) {
        campo4.setText(n);
    }
    //public void setCampo5(String n) { campo5.setText(n); }

    public void setComboBox(String n) {
        comboBox.setSelectedItem(n);
    }

    public void setComboBoAutor(String n) {
        comboBoAutor.setSelectedItem(n);
    }
    ...
    public String getComboBoAutor() {
        return String.valueOf(comboBoAutor.getSelectedItem());
    }

    //****************************getTabla*****************************//
    public DbTabla getTabla() {
        return tabla;
    }

    public void agregarItem(Integer n) {
        comboBox.addItem(n);
    }
