    ...
    public List<Editorial> listEditorial() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                // for(Editorial q:editoriales){
                //vistaLibro.agregarItem(q.getIdEditorial());
                //}
                for(Editorial q:editoriales){
                    System.out.println(q.getIdEditorial());
                }
            }
        } catch (SQLException exception) {
